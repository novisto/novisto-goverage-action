...
func TestListProjects(t *testing.T) {
	...
	setup := func(returnValue interface{}, returnError error) (*Router, echo.Context, *httptest.ResponseRecorder) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/repos/repo1/projects", nil)
		rec := httptest.NewRecorder()
		c := router.e.NewContext(req, rec)
...
func TestListBranches(t *testing.T) {
	...
	setup := func(returnValue interface{}, returnError error) (*Router, echo.Context, *httptest.ResponseRecorder) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/repos/repo1/projects/project1/branches", nil)
		rec := httptest.NewRecorder()
		c := router.e.NewContext(req, rec)
